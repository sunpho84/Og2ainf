...
template <typename F>
void intComp(valarray<F>& Int,valarray<F>& IntS,int i)
{
  int i4=i%T;
  i/=T;
  int i3=i%L;
  ...
  Int[9] += Fac*(((S2xSSP2*SS2)/(64.*Delta12p2)+(S2xSSP2xAtxS2*SS2)/(64.*Den)-(SS2*SSP2)/(64.*Delta12p2)-(SS2*SSP2xAtxS2)/(64.*Den)-(S2xSSxSSP*SSxSSP)/(32.*Delta12p2)-(S2xSSxSSPxAtxS2*SSxSSP)/(32.*Den)+SSxSSP*SSxSSP/(64.*Delta2p2)-(AtxS2*SSxSSP*SSxSSP)/(64.*Den)-SSxSSP*SSxSSP/(32.*Delta12p2)+(S2xAtxS2*SSxSSP*SSxSSP)/(64.*Den)+(SSxSSP*SSxSSPxAtxS2)/(32.*Den)-(SSxSSP*SSxSSPxAtxSS2)/(128.*Den)+(SS2*SSxSSPxAtxSSxSSP)/(256.*Den))-(-(SS2*(4.0*Delta1*S2xSS2 + 4.0*S2xSS2xAtxS2 + 4.0*AtxS2*SS2 + 12*Delta1*SS2 - 4.0*Delta12*SS2 - 4.0*S2xAtxS2*SS2 - 4.0*SS2xAtxS2 + SS2xAtxSS2))/(256.0*Delta12*Delta22)));
  ...
  IntS[2] += Fac*(((32.0*Delta1*Delta1p*PxCPxSP + 32*Delta1p*PxCPxSPxAtxS2 - 16.0*PxCPxSxAtxCPxSxSSP - 32*Delta1p*PxCPxSxAtxSxSP + AtxS2*Delta2p*PxSINP + 3*Delta1*Delta2p*PxSINP - 16.0*Delta1*PxSP2xSSP - 16.0*PxSP2xSSPxAtxS2 - 8.0*AtxS2*PxSSP + 16.0*PxSSPxAtxS2 - 8.0*PxSSP*S2xSP2 - 32*Delta1p*PxCPxS*SxSP + 8.0*PxSSP*SxSP*SxSP + 8.0*PxSSP*SxSPxAtxSxSP)/(32.*Delta12*Delta2p*P2))-((8.0*CCxS2xSS2xAtxS2 + 8.0*CCxS2xSS2*Delta1 - 8.0*Delta1*Delta2 + 48.0*Delta12*Delta2 + 3*Delta1*Delta22 - 12*Delta12*Delta2*S2 + 4.0*Delta2*S2xAtxS2 - 12*Delta1*Delta2*S2xAtxS2 - 8.0*Delta1*S2xSS2 + 24.0*Delta12*S2xSS2 - 2*Delta2*S2xSS2 + 8.0*S2xAtxS2*S2xSS2 + 16.0*S2xSS2xAtxS2 + 16.0*Delta1*S2xSS2xAtxS2 - 4.0*S2xSS2xAtxSS2 + 4.0*Delta1*SS2 + 4.0*Delta12*SS2 + 2*Delta2*SS2 - 7*Delta1*Delta2*SS2 - 8.0*Delta12*S2*SS2 - 4.0*S2xAtxS2*SS2 - 8.0*Delta1*S2xAtxS2*SS2 + 2*S2xSS2*SS2 - SS2*SS2 - 2*Delta1*SS2*SS2 + AtxS2*(Delta2*(-4.0 + 12*Delta1 + Delta2) - 8.0*S2xSS2 + (4.0 + 8.0*Delta1)*SS2)- 8.0*SS2xAtxS2 - 16.0*Delta1*SS2xAtxS2 - 2*Delta2*SS2xAtxS2 + 2*SS2xAtxSS2 + 4.0*Delta1*SS2xAtxSS2)/(32.*Delta12*Delta22)));
